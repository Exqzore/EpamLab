...
public class UserDaoImpl implements UserDao, SortParameterInserter {
  ...
  @Autowired
  public UserDaoImpl(SortingCalculator<UserSortBy> sortingCalculator, SortingCalculator<OrderSortBy> ordersSortingCalculator) {
